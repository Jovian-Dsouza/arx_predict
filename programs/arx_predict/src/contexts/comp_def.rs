...
#[derive(Accounts)]
pub struct InitBuySharesCompDef<'info> {
    #[account(mut)]
    pub payer: Signer<'info>,
    #[account(
        mut,
...
#[derive(Accounts)]
pub struct InitSellSharesCompDef<'info> {
    #[account(mut)]
    pub payer: Signer<'info>,
    #[account(
        mut,
...
#[init_computation_definition_accounts("reveal_probs", payer)]
#[derive(Accounts)]
pub struct InitRevealProbsCompDef<'info> {
    #[account(mut)]
    pub payer: Signer<'info>,
    #[account(
        mut,
